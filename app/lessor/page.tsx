...
const LessorPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/lessor/submit", {
        method: "POST",
        headers: {
          ...
          <Card className="border-zinc-200/60 shadow-xl">
            <CardHeader className="space-y-3 text-center pb-6">
              ...
              <CardDescription className="text-base">
                You must sign in or sign up first before you can list your property for rent.
              </CardDescription>
            </CardHeader>
        ...
        >
          ...
          <Card className="border-zinc-200/60 shadow-xl">
            <CardHeader>
              ...
              <CardDescription>
                Please provide all the required information to list your property
              </CardDescription>
            </CardHeader>
            <CardContent>
